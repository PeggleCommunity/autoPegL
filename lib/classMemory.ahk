...
; I lifted this from https://github.com/Azerate218/classMemory-v2
; It promises only basic funcionality, so hopefully it works for my purposes xdd
/*
...
class _ClassMemory
{
    ...
    */
    ...
    bufferScanForMaskedPattern(hayStackAddress, sizeOfHayStackBytes, & patternMask, needleAddress, startOffset := 0)
    {
        static p
        if !p
        {
